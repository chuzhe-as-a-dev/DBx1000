...
void cc_release_op(txn_man* txn, row_t* orig_row, row_t* local_row,
                   access_t type, int op_idx) {
  (void)txn; (void)orig_row; (void)local_row; (void)type; (void)op_idx;
}
